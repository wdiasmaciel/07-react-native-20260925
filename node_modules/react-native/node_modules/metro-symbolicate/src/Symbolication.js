...
class SymbolicationContext {
  ...
  symbolicateChromeTrace(traceFile, { stdout, stderr }) {
    const content = JSON.parse(_nodeFs.default.readFileSync(traceFile, "utf8"));
    ...
    _nodeFs.default.writeFileSync(traceFile, JSON.stringify(content));
  }
...
class DirectorySymbolicationContext extends SymbolicationContext {
  ...
  _loadMap(mapFilename) {
    (0, _invariant.default)(
      _nodeFs.default.existsSync(mapFilename),
    ...
    if (fileMap == null) {
      fileMap = new SingleMapSymbolicationContext(
        ...
        _nodeFs.default.readFileSync(mapFilename, "utf8"),
        this.options,
      );
  ...
  getOriginalPositionDetailsFor(lineNumber, columnNumber, filename) {
    ...
    let mapFilename;
    const relativeFilename = _nodePath.default.relative(
      this._rootDir,
      _nodePath.default.resolve(this._rootDir, filename),
    );
    if (!relativeFilename.startsWith("..")) {
      mapFilename = _nodePath.default.join(
        this._rootDir,
        relativeFilename + ".map",
      );
    }
    if (mapFilename == null || !_nodeFs.default.existsSync(mapFilename)) {
      lineNumber =
        lineNumber != null
          ? lineNumber -
            this.options.inputLineStart +
