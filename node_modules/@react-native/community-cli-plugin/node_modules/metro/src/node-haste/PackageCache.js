...
const readPackageJsonSync = (absolutePackageJsonPath) =>
  JSON.parse((0, _nodeFs.readFileSync)(absolutePackageJsonPath, "utf8"));
class PackageCache {
  #getClosestPackage;
  #readPackageJson;
  #packageCache;
  ...
  getPackage(filePath) {
    ...
    if (cached == null) {
      cached = {
        rootPath: (0, _nodePath.dirname)(filePath),
  ...
  invalidate(filePath) {
    ...
    if (cachedResult != null) {
      const packagePath =
        cachedResult.rootPath + _nodePath.sep + "package.json";
    ...
    if (filePath.endsWith(_nodePath.sep + "package.json")) {
