...
const debug = (0, _debug.default)("Metro:Transformer");
class Transformer {
  ...
  async transformFile(filePath, transformerOptions, fileBuffer) {
    ...
    const projectRelativePath = _nodePath.default.relative(
      this._config.projectRoot,
      filePath,
    );
    const partialKey = (0, _metroCache.stableHash)([
      this._baseHash,
      (0, _pathUtils.normalizePathSeparatorsToPosix)(projectRelativePath),
      customTransformOptions,
      dev,
      experimentalImportSupport,
      inlinePlatform,
    ...
    return {
      ...
      getSource() {
        ...
        return _nodeFs.default.readFileSync(filePath);
      },
    };
  }
  async end() {
...
function verifyRootExists(root) {
  (0, _nodeAssert.default)(
    _nodeFs.default.statSync(root).isDirectory(),
