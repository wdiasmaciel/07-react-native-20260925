 ...
 * @noformat
 * @oncall react_native
 * @generated SignedSource<<7c33332b8f4c62d2bca2430ae332dece>>
 *
...
export declare class Graph<T = MixedOutput> {
  ...
  _recursivelyCommitModule(path: string, delta: Delta<T>, options: InternalOptions<T>, commitOptions?: Readonly<{onlyRemove: boolean}>): Module<T>;
  ...
  _reorderDependencies(module: Module<T>, orderedDependencies: Map<string, Module<T>>, options: {shallow: boolean}): void;
