 ...
 * @noformat
 * @oncall react_native
 * @generated SignedSource<<237c7374af186b92f75b2523e1cb8820>>
 *
...
type ProcessStartContext = Omit<SplitBundleOptions, 'buildNumber' | 'bundleOptions' | 'graphId' | 'graphOptions' | 'mres' | 'req' | 'revisionId' | 'bundlePerfLogger' | 'requestStartTimestamp'> & {
...
type ProcessEndContext<T> = Omit<ProcessStartContext, 'result'> & {
  readonly result: T;
};
...
declare class Server {
  ...
  _createRequestProcessor<T>($$PARAM_0$$: {
    ...
    readonly delete?: ((context: ProcessDeleteContext) => Promise<void>) | undefined;
  ...
  _resolveWatchFolderPrefix(filePath: string): {rootDir: string; filePath: string} | null;
