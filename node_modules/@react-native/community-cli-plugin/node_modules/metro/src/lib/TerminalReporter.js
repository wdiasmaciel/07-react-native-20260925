...
const style = (format, text) => _nodeUtil.default.styleText(format, text);
...
class TerminalReporter {
  ...
  _getBundleStatusMessage(
    ...
    const localPath = _nodePath.default.relative(".", entryFile);
    ...
    return (
      ...
      style(["reset", "dim"], ` ${_nodePath.default.dirname(localPath)}/`) +
      style(["bold"], _nodePath.default.basename(localPath)) +
      " " +
      progress
    );
  }
