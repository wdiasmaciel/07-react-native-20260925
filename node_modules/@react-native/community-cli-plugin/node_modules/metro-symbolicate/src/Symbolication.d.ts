 ...
 * @noformat
 * @oncall react_native
 * @generated SignedSource<<f785aee75a2b04f41f47b7dda1b94bbd>>
 *
...
type ContextOptionsInput = {
  readonly nameSource?: 'function_names' | 'identifier_names' | undefined;
  readonly inputLineStart?: number | undefined;
  readonly inputColumnStart?: number | undefined;
  readonly outputLineStart?: number | undefined;
  readonly outputColumnStart?: number | undefined;
};
type SizeAttributionMap = {
  location: {
    ...
    virtualOffset?: number | undefined;
...
type HermesMinidumpStackFrame = Readonly<{
  ...
  FunctionID: number;
  CJSModuleOffset?: number | undefined;
...
declare class SingleMapSymbolicationContext extends SymbolicationContext<SingleMapModuleIds> {
  readonly _segments: {
    readonly [id: string]: {
      ...
      readonly sourceFunctionsConsumer: null | undefined | SourceMetadataMapConsumer;
