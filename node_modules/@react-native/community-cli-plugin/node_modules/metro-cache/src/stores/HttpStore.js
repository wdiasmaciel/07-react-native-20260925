...
class HttpStore {
  ...
  #createEndpointConfig(options) {
    ...
    const module =
      uri.protocol === "http:" ? _nodeHttp.default : _nodeHttps.default;
    const agent =
      options.proxy != null
    ...
    return {
      ...
      module: uri.protocol === "http:" ? _nodeHttp.default : _nodeHttps.default,
  ...
  #getOnce(key) {
    return new Promise((resolve, reject) => {
      ...
      const req = this.#getEndpoint.module.request(options, (res) => {
              ...
              reject(
                new _HttpError.default(
                  "Encountered network error (" +
                    ...
                    code +
                    " " +
                    _nodeHttp.default.STATUS_CODES[code],
                  code,
                ),
              );
            });
        ...
        const gunzipped = res.pipe(_nodeZlib.default.createGunzip());
  ...
  #setOnce(key, value) {
    return new Promise((resolve, reject) => {
      const gzip = _nodeZlib.default.createGzip(ZLIB_OPTIONS);
