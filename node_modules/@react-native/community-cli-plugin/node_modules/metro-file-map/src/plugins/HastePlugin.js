...
class HastePlugin {
  ...
  #onNewFile(canonicalPath, id) {
    ...
    const module = [
      ...
      _nodePath.default.basename(canonicalPath) === "package.json"
        ? _constants.default.PACKAGE
        : _constants.default.MODULE,
    ];
  ...
  computeConflicts() {
    ...
    for (const [id, data] of this.#map) {
      ...
      for (const basePlatform of [
        ...
        const basePathDir = _nodePath.default.dirname(basePath);
        for (const platform of Object.keys(data)) {
          ...
          if (_nodePath.default.dirname(platformPath) !== basePathDir) {
