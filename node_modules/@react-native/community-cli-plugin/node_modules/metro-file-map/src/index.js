...
Object.defineProperty(exports, "NoopCacheManager", {
  enumerable: true,
  get: function () {
    return _NoopCacheManager.NoopCacheManager;
  },
});
...
var _NoopCacheManager = require("./cache/NoopCacheManager");
...
const debug = (0, _debug.default)("Metro:FileMap");
...
class FileMap extends _nodeEvents.default {
  #buildPromise;
  #cacheManager;
  ...
  constructor(options) {
    ...
    const pluginWorkers = [];
    const pluginDataIndices = new Map();
    ...
    this.#crawler = options.crawlerFactory
      ? options.crawlerFactory.call(null, {
          buildParameters,
          pluginDataIndices,
        })
      : null;
