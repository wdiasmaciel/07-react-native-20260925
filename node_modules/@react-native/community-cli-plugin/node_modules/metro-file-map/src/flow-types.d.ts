 ...
 * @noformat
 * @oncall react_native
 * @generated SignedSource<<cb21194605526c0aba78e0ecad60119a>>
 *
...
export type InputFileMapPlugin = FileMapPlugin<
  /**
   * > 264 | export type InputFileMapPlugin = FileMapPlugin<empty, empty>;
...
export type WatcherBackendChangeEvent =
  | Readonly<{
      event: 'touch';
      clock?: ChangeEventClock | undefined;
      relativePath: string;
      root: string;
...
export type WorkerMetadata = Readonly<{
  ...
  pluginData?: ReadonlyArray<V8Serializable> | undefined;
}>;
export type WorkerSetupArgs = Readonly<{
  plugins?: ReadonlyArray<FileMapPluginWorker['worker']> | undefined;
}>;
