...
const debug = (0, _debug.default)("Metro:Watcher");
const MAX_WAIT_TIME = 240000;
let nextInstanceId = 0;
class Watcher extends _nodeEvents.default {
  #activeWatcher;
  #backends = [];
  #instanceId;
  #nextHealthCheckId = 0;
  ...
  async #crawl(crawlOptions) {
    ...
    const crawl =
      options.crawl ?? (useWatchman ? _watchman.default : _node.default);
  ...
  async checkHealth(timeout) {
    ...
    const observationPromise = new Promise((resolve) => {
      ...
      if (!result) {
        result = {
          type: "success",
          timeElapsed: _nodePerf_hooks.performance.now() - startTime,
          timeout,
          watcher,
        };
      }
