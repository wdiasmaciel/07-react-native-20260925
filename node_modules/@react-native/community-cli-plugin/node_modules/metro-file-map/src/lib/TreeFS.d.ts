 ...
 *
 * @noformat
 * @generated SignedSource<<38f76ea8eafa68c3e0ae7f25777c0518>>
 *
...
declare class TreeFS implements MutableFileSystem {
  ...
  getDifference(files: FileData, options?: Readonly<{subpath?: string | undefined}>): {changedFiles: FileData; removedFiles: Set<string>};
  getSha1(mixedPath: Path): null | undefined | string;
  getOrComputeSha1(mixedPath: Path): Promise<null | undefined | {sha1: string; content?: Buffer | undefined}>;
